...
class CREATIONRPGPROJECT_API UInventoryComponent : public UActorComponent
{
	GENERATED_BODY()
...
protected:
	...
	int32 CalcualteNumberForFullStack(UItemBase* StackableItem, int32 InitialRequestedAddAmount);
