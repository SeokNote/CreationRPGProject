...
{
	InstanceInteractableData.InteractableType = EInteratableType::PickUp;
...
void APickup::Interact(AKwang* PlayerCharacter)
{
	if (PlayerCharacter)
	{
...
void APickup::TakePickup(const AKwang* Taker)
{
